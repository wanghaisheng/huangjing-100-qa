...
export const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer: "能显著下调肝脏 and 血液中的 MDA 含量，缓解氧化应激。"
  },
  {
    category: "肝脏保护、降糖与代谢",
  ...
  {
    category: "脑健康、神经保护与综合应用",
    question: "黄精对 brain 组织中乙酰胆碱酯酶的影响？",
    answer: "能下调该酶活性，从而提高脑内乙酰胆碱水平，改善认知。"
  },
  {
    category: "脑健康、神经保护与综合应用",
    question: "哪种炮制品在 AD 药效上表现优异？",
    answer: "酒黄精、炆黄精 and 黑豆制黄精均有药效，且通过 UPLC-Q/TOF-MS 发现炮制后差异成分多样化。"
  },
  {
    category: "脑健康、神经保护与综合应用",
    question: "黄精能延缓衰老吗？",
  ...
  },
  {
    category: "脑健康、神经保护与综合应用",
    question: "黄精能预防骨质疏松吗？",
    answer: "文献综述提到多糖 and 皂苷具有改善骨密度的潜在药理价值。"
  },
  {
    category: "脑健康、神经保护与综合应用",
  ...
  // 第六部分：安全性与质量控制
  {
    ...
    answer: "根据最新研究数据，随着蒸晒次数从 0 次增加到 9 次，总酚含量从 1.036 mg GAE/g 显著提升至 7.627 mg GAE/g；还原糖含量也从 47.599 mg GE/DW 增长至 465.333 mg GE/DW（增长约 10 倍），这科学解释了炮制后黄精甜度增加及抗氧化能力增强的本质。"
  },
  {
    category: "炮制工艺与化学成分转化",
  ...
  },
  {
    ...
    answer: "发酵工艺通过微生物降解大分子并破坏细胞壁，使活性物质最大化释放。实验显示，发酵 30 小时的黄精 DPPH 清除能力可达 844.80 μmol/g，且其主要成分的生物可及性（Bioaccessibility）达到最高水平，能有效逆转结肠缩短并降低 DAI 评分。"
  },
  {
    category: "安全性与质量控制",
    question: "云南地区滇黄精的重金属含量实测情况如何？",
    answer: "对云南 10 个产地的滇黄精测定显示，不同产地差异巨大。虽然多数符合标准，但部分样品存在超标风险：如某些样品镉（Cd）含量达 1.46 mg/kg（标准 0.3），铅（Pb）达 9.10 mg/kg（标准 5.0），这强调了选址种植时进行土壤重金属筛查的重要性。"
  },
  {
    category: "安全性与质量控制",
    question: "多花黄精的农药残留实测数据是否符合绿色行业标准？",
    answer: "对新野、南平、郴州、湘西等 11 个产地的多花黄精进行测定，其五氯硝基苯、六六六、滴滴涕（DDT）的含量均低于 0.1 mg/kg，完全符合《药用植物及制剂外经贸绿色行业标准（WM/T2-2004）》，安全性良好。"
  },
  {
    category: "安全性与质量控制",
    question: "《中国药典》对黄精的安全性指标有哪些规定？",
    answer: "2020 版《中国药典》一部对多花黄精中的重金属及有害元素有明确限量规定，但目前尚未见对有机氯农残的专门限量规定。"
  }
];
