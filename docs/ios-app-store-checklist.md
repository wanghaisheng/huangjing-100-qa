...
- [ ] **发布操作**：审核状态变为 Ready for Distribution 后，必须手动点击“Set Up Availability”（发布到商店）（否则 App 会显示 “Removed from Sale”）
- [ ] **线上验证**：发布后请用另一部设备（非开发者账号）实际下载、订阅一次
